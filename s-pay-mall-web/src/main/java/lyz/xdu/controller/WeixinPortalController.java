...
import lyz.xdu.common.weixin.MessageTextEntity;
import lyz.xdu.common.weixin.SignatureUtil;
import lyz.xdu.common.weixin.XmlUtil;
import lyz.xdu.service.ILoginService;
...
/**
 * 微信服务对接，对接地址：<a href="http://lyz1010.natapp1.cc/api/v1/weixin/portal/receive">/api/v1/weixin/portal/receive</a>
 * <p>
 * http://lyz1010.natapp1.cc/api/v1/weixin/portal/receive/
 */
@Slf4j
@RestController()
@CrossOrigin("*")
